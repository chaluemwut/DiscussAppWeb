 ...
 */
@WebServlet("/jsonPost_reply")
public class jsonPost_reply extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public jsonPost_reply() {
        super();
	...
	public void performTask(HttpServletRequest request, HttpServletResponse response) throws IOException, ClassNotFoundException, SQLException, ServletException{
		...
		conndb.toppicId=topic_id;
		
		JsonObject jsonObj = conndb.PostAPI();
