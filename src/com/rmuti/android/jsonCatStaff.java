...
/**
 * Servlet implementation class jsonCatStaff
 */
@WebServlet("/jsonCatStaff")
public class jsonCatStaff extends HttpServlet {
 ...
 public void performTask(HttpServletRequest request, HttpServletResponse response) throws IOException, ClassNotFoundException, SQLException, ServletException{
 	...
 	JsonObject jsonObj2 = conndb.jsonCatStaff(username);
