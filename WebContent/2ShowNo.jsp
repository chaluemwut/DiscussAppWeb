...
<FORM  name="form1" ACTION="PostReply2" METHOD="post" onSubmit="JavaScript:return fncSubmit();">
...
<center><table background="img/bgtb.png"  border="1" bordercolor="white" cellpadding="10" cellspacing="0" style="width: 80%; " >
	...
	try {
		...
		String sql = "select * from 2post where topic_id='"+request.getParameter("id")+"'";
		String sql2 = "select * from 2post_reply where topic_id='"+request.getParameter("id")+"'";
...
%>
					...
					<center><img src=<%="images2/"+topic_id+".png"%> width="500" height="500" ></center> <br>
...
%>
		...
		&nbsp;<a class="btn btn-danger" href="2AllTopicNoLogin.jsp" role="button">ดูกระทู้ทั้งหมด</a>
