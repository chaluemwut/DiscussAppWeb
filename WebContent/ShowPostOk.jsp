...
<center><table background="img/bgtb.png"  border="1" bordercolor="white" cellpadding="10" cellspacing="0" style="width: 80%; " >
	  <tr>
       ...
       <tr>
        ...
        <tr>
           <td><h3><center> สร้างกระทู้ของคุณเรียบร้อย  !!! </center></h3></td>
        
        </tr>
         <tr>
          <td> <p align="center"><a  class="btn btn-success" href="ShowCatID.jsp?id=<%=request.getParameter("id")%>" role="button">ดูกระทู้ทั้งหมด</a></p><br></td>
         </tr>
