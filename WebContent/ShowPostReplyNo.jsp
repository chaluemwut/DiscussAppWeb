...
<center><table background="img/bgtb.png"  border="1" bordercolor="white" cellpadding="10" cellspacing="0" style="width: 80%; " >
	  <tr>
       ...
       <tr>
        ...
        <tr>
           <td><h3><center> ไม่สามารถรับคำตอบลงกระทู้ได้ กรุณาลองใหม่!! </center></h3></td>
        
        </tr>
         <tr>
          <td> <p align="center"><a  class="btn btn-success" href="ShowTopic.jsp?id=<%=request.getParameter("id")%>" role="button">กลับไปตอบกระทู้ใหม่</a></p><br></td>
         </tr>
