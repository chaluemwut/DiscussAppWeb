  ...
  <%//--------------------------------จำนวนกระทู้ที่โพส------------------------------------------------- %>
	  <%
          	request.setCharacterEncoding("UTF-8");
        			...
        			Connection conNum = DriverManager.getConnection("jdbc:mysql://localhost:3306/"+Config.db_name+"?characterEncoding=utf-8",Config.db_user,Config.db_password);       			
        			...
        			request.setCharacterEncoding("UTF-8");        			
        			Class.forName("org.gjt.mm.mysql.Driver");        		
        			Connection conNum2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/"+Config.db_name+"?characterEncoding=utf-8",Config.db_user,Config.db_password);      			
